...
public class EaseMessageAdapter extends BaseAdapter{
	...
	protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        //在这里可以修改布局  
        case TXT:
            chatRow = new EaseChatRowText(context, message, position, this,this.chatType);
            break;
        case LOCATION:
            chatRow = new EaseChatRowLocation(context, message, position, this,this.chatType);
            break;
        case FILE:
            chatRow = new EaseChatRowFile(context, message, position, this,this.chatType);
            break;
        case IMAGE:
            chatRow = new EaseChatRowImage(context, message, position, this,this.chatType);
            break;
        case VOICE:
            chatRow = new EaseChatRowVoice(context, message, position, this,this.chatType);
            break;
        case VIDEO:
            chatRow = new EaseChatRowVideo(context, message, position, this,this.chatType);
            break;
        default:
            break;
        }
