...
//	  private static final int PADDING_VERTICAL = 5;//垂直方向padding
	  public final int SIDE_MARGIN = UITools.dip2px(10);//定义容器左右两边的padding
	  public final int TEXT_MARGIN = UITools.dip2px(8);  // 定义子View之间的间隔距离
	  /**
	   * @param context
	   */
...
//	      view.setBackgroundColor(Color.GREEN);
	      ...
	      x += width+TEXT_MARGIN;
	      if(x>autualWidth+TEXT_MARGIN-SIDE_MARGIN){
...
//	      child.setPadding(PADDING_HOR, PADDING_VERTICAL, PADDING_HOR, PADDING_VERTICAL);
	      ...
	      x += width+TEXT_MARGIN;
	      if(x>actualWidth+TEXT_MARGIN){//换行
	        x = width+TEXT_MARGIN;
	        rows++;
	      }
	      y = rows*(height+TEXT_MARGIN);
