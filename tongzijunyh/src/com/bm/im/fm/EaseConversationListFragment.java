	...
	protected void setUpView() {
		...
		conversationListView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				View popLayout = LayoutInflater.from(getActivity()).inflate(com.richer.tzj.R.layout.layout_popupwindow_style01,null);
				...
				int x = DensityUtil.dip2px(getActivity(), 40);
				int xPos = windowManager.getDefaultDisplay().getWidth() / 2 -x ;
				...
				popLayout.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
				        ...
				        // 删除此会话 最后一个boolean参数的意思是不是要把聊天内容也删除掉。false 不删除， true删除
