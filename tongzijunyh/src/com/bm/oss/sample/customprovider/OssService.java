...
public class OssService {
    ...
    private OSSCallback mDisplayer;
    private String mCallbackAddress;
    private static String mResumableObjectKey = "resumableObject";

    public OssService(OSS oss, String bucket, OSSCallback uiDisplayer) {
        this.mOss = oss;
        this.mBucket = bucket;
    ...
    public void asyncPutImage(String object, String localFile) {
        ...
        if (mCallbackAddress != null) {
            ...
            Log.e("debug==put", put.getObjectKey());
            Log.e("debug==put", put.getCallbackParam().toString());
        }
