...
public class Config {
    ...
    // 访问的endpoint地址
//    public static final String imgPoint = "http://img-cn-hangzhou.aliyuncs.com";
    //callback 测试地址
    public static final String callbackAddress = "http://59.110.62.10:8888/tongZiJun/api/OSSApi/callback?filename=%s&fkid=%s";
