...
public class ShareUtil {
    ...
    public void shareInfo(final ShareModel model) {
        shareModel = model;
        Log.e("shareUrl", model.targetUrl);
        ...
        new ShareAction(context).setDisplayList(SHARE_MEDIA.WEIXIN, SHARE_MEDIA.WEIXIN_CIRCLE, SHARE_MEDIA.SINA, SHARE_MEDIA.QZONE)
                ...
                .withMedia(new UMImage(context, shareModel.urlImg))
                .open();
    }
    ...
    private ShareBoardlistener shareBoardlistener = new ShareBoardlistener() {
        ...
        public void onclick(SnsPlatform snsPlatform, SHARE_MEDIA share_media) {
            ...
            if (shareModel.urlImg == null) {
                img = new UMImage(context, BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_launchers));
            } else {
                img = new UMImage(context, shareModel.urlImg);
            }
