...
public class ZhouMoAdapter1 extends ArrayAdapter<CourseBean> {

    List<CourseBean> list ;

    Context context;
    public ZhouMoAdapter1(Context context) {
        super(context, 0);
    ...
    @Override
        ...
        if(convertView == null)
        {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_zhoumo1, parent, false);
        }
