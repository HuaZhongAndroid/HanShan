...
public class NsRefreshLayout extends FrameLayout {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        loadingViewFinalHeight = LoadView.dipToPx(context, LOADING_VIEW_FINAL_HEIGHT_DP);
...
//            headerView = new LoadView(getContext());
            headerView  = LayoutInflater.from(getContext()).inflate(R.layout.view_refresh_header_normal_image, null);
